...
export interface AppScreenConstructor<P> {
	new (props: P): IAppScreen;
	assetBundles?: string[];
}
...
export class Navigation {
	 ...
	 */
	public async showScreen<P>(ctor: AppScreenConstructor<P>, props?: P) {
		...
		this.currentScreen = new ctor(props!);
